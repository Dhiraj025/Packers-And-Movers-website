                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="origin" class="control-label">Origin <small class="text-muted"><i>(Where the package located from?)</i></small> <small class="text-danger">*</small></label>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="destination" class="control-label">Destination <small class="text-muted"><i>(Where your package need to be delivered?)</i></small> <small class="text-danger">*</small></label>
